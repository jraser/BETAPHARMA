...
var SocioNegocioAddClienteController = function ($rootScope, $scope, $modalInstance, $http, scope) {
...
SocioNegocioAddClienteController.$inject = ['$rootScope', '$scope', '$modalInstance', '$http', 'scope'];
